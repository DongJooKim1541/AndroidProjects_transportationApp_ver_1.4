...
public class Subway_findBusRouteParser {
    ...
    public ArrayList<SubwayItems> Subway_findBusRouteApi(String subwayStationId, ArrayList<SubwayItems> list, int pageNo){
        ...
        try{
            ...
            String urlStr="http://openapi.tago.go.kr/openapi/service/SubwayInfoService/getSubwaySttnExitAcctoBusRouteList?subwayStationId="+subwayStationId+"&pageNo="+pageNo+"&serviceKey="+key;
            ...
            while(parserEvent!= XmlPullParser.END_DOCUMENT){
                ...
                if(parserEvent==XmlPullParser.START_TAG){
                    ...
                    if(tagName.equalsIgnoreCase("busRouteNo")){
                        String busRouteNo=parser.nextText();
                        si.setBusRouteNo(busRouteNo);
                    }
